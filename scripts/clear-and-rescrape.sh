...
firebase firestore:delete / --all-collections --force --project community-data-scraper-service

echo "Waiting for deletion to complete..."
sleep 3

echo "Triggering community events sync..."
curl "https://us-central1-community-data-scraper-service.cloudfunctions.net/triggerCommunityEventsSync?forceRefresh=true"
...
echo "  'https://us-central1-community-data-scraper-service.cloudfunctions.net/api/feed?start=2025-09-29&days=7' | python3 -m json.tool"